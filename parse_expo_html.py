#!/usr/bin/env python3
"""
Parser for expo_raw.html that extracts event data and exports to CSV.
"""
...
def parse_expo_html(html_file_path):
    """
    Parse expo HTML file and extract event data.
...
def main():
    ...
    html_file = script_dir / "expo_raw.html"
    csv_file = script_dir / "expo_events.csv"
    ...
    events = parse_expo_html(html_file)
