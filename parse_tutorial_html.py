#!/usr/bin/env python3
"""
Parser for tutorial_raw.html that extracts event data and exports to CSV.
"""
...
def parse_tutorial_html(html_file_path):
    """
    Parse tutorial HTML file and extract event data.
...
def main():
    ...
    html_file = script_dir / "tutorial_raw.html"
    csv_file = script_dir / "tutorial_events.csv"
    ...
    events = parse_tutorial_html(html_file)
